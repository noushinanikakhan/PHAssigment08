...
<div className='flex justify-between items-center p-5'>
  ...
  <select defaultValue="Pick a browser" className="select">
    <option className='text-[#627382]' disabled={true}>Sort by size</option>
    <option className='text-[#627382]'>Chrome</option>
    <option className='text-[#627382]'>FireFox</option>
    <option className='text-[#627382]'>Safari</option>
  </select>
</fieldset>
         </div>
